    ...
    <div className="w-full h-full min-h-[600px] bg-background flex flex-col p-6">
      ...
      <main className="flex-1 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-[320px] aspect-square bg-card rounded-2xl border-2 border-dashed border-border flex items-center justify-center mb-8 shadow-sm">
          <div className="text-center p-6">
            ...
            <p className="text-sm text-muted-foreground">Animation showing hand drawing</p>
          </div>
        </div>
        ...
        <div className="text-center max-w-md px-4">
          <p className="text-[22px] leading-relaxed text-foreground font-medium">
            ...
            <span className="text-primary font-bold">11:10</span>.
          </p>
        </div>
      </main>
      ...
      <footer className="mt-6">
        <button
          ...
          className="w-full min-h-[64px] px-8 py-4 bg-primary text-primary-foreground font-bold text-xl rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-200 active:scale-[0.98] flex items-center justify-center gap-3"
        >
